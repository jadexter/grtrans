...
C$omp threadprivate(/DLS001/,/DLSS01/)
C-----------------------------------------------------------------------
...
C$omp threadprivate(/DLS001/,/DLSA01/)
C-----------------------------------------------------------------------
...
C$omp threadprivate(/DLSA01/,/DLS001/)
C-----------------------------------------------------------------------
...
*DECK DRCHEK
     ...
     1   IOWND3(3), IOWNR3(2), IRFND, ITASKC, NGC, NGE
      ...
      LOGICAL ZROOT
C$omp threadprivate(/DLS001/,/DLSR01/)
C-----------------------------------------------------------------------
...
C$omp threadprivate(/DLPK01/,/DLS001/)
C-----------------------------------------------------------------------
...
*DECK DPKSET
     ...
     1   JPRE, JACFLG, LOCWP, LOCIWP, LSAVX, KMP, MAXL, MNEWT,
     2   NNI, NLI, NPS, NCFN, NCFL
C$omp threadprivate(/DLS001/,/DLPK01/)
C-----------------------------------------------------------------------
...
*DECK DSTOKA
     ...
     1   JPRE, JACFLG, LOCWP, LOCIWP, LSAVX, KMP, MAXL, MNEWT,
     2   NNI, NLI, NPS, NCFN, NCFL
C$omp threadprivate(/DLS001/,/DLS002/,/DLPK01/)
C-----------------------------------------------------------------------
...
C$omp threadprivate(/DLSS01/,/DLS001/)
C-----------------------------------------------------------------------
C This routine performs preprocessing related to the sparse linear
