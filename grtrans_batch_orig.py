...
class grtrans_inputs:
    ...
    def write(self,fname):
        ...
        nargs=[len(args)]
        args1=['fname','dt','nt','nmdot','mdotmin','mdotmax']
        nargs.append(len(args1))
        args2=['ename','mbh','nfreq','fmin','fmax']
        ...
        vals.extend([self.fname,self.dt,self.nt,self.nmdot,self.mdotmin,self.mdotmax])
        vals.extend([self.ename,self.mbh,self.nfreq,self.fmin,self.fmax])
